...
-- {{{ Key bindings
globalkeys = gears.table.join(awful.key({modkey}, "r", function()
...
awful.spawn.with_shell("xrandr --output HDMI-0 --mode 1920x1080 --rate 239.76")
awful.spawn.with_shell("nitrogen --restore")
awful.util.spawn("xsetroot -cursor_name left-ptr")
